...
<div class="card min-w-full">
    <div class="">
        ...
        <div class="modal-body mb-5">
            <form action="{{ route('money.for.update', $money_for->id) }}" method="POST">
                @csrf
                <input value="{{ $money_for->name }}" class="w-full border p-3" name="name" type="text" placeholder="এখানে লিখুন">
                ...
                <button class="text-md bg-primary text-light py-1 px-4 rounded">আয়ের বাবদ আপডেট করুন</button>
            </form>
        </div>
    </div>
</div>
